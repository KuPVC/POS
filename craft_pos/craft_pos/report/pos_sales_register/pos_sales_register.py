...
def get_pos_entries(filters, group_by_field):
	...
	return frappe.db.sql(
		"""
		SELECT
			concat(p.posting_date," ",p.posting_time) AS posting_date, p.name as pos_invoice, p.pos_profile,
...
def get_columns(filters):
	columns = [
		{"label": _("Posting Date"), "fieldname": "posting_date", "fieldtype": "Datetime", "width": 90},
		{
			"label": _("POS Invoice"),
